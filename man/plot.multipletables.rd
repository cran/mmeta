...
\usage{
    \method{plot}{multipletables}(x,type=NULL,select=NULL, xlim=NULL,ylim=NULL,
...
# Plot the posterior density functions of some target studies in a side-by-side manner
...
plot(multiple.RD, type="sidebyside", select=c(3,8,14,16), ylim=c(0,6), xlim=c(-0.2,0.4))
}
}
